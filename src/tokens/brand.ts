...
export const typeScale = {
  ...
  bodyLg: { min: 18, max: 22, lineHeight: 1.5, tracking: 0.01, weight: 400 },
  body: { min: 16, max: 18, lineHeight: 1.5, tracking: 0, weight: 400 },
...
export const glass = {
   ...
   */
  edge: {
    light: { highlight: 0, shade: 0.26, border: 0.18 },
    dark: { highlight: 0, shade: 0.6, border: 0.22 },
  },
  /**
